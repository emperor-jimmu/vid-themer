...
- **Theme_Clip**: The extracted 10-15 second video segment saved as "backdrop.mp4"
...
1. WHEN a Source_Video is processed, THE Clip_Extractor SHALL extract a segment between 10 and 15 seconds in duration
...
4. WHEN the Source_Video duration is less than 10 seconds, THE Clip_Extractor SHALL extract the entire video
